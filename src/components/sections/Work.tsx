...
export default function Work() {
    ...
    const projects = [
        {title: 'Landing Page', image: portfolio2, icons: [i6typescript, i7html5, i11vite, i8CSS3, i12git, i9intelij,], link: 'https://portfolio2.renatobonfim.com/', description: 'This minimalist landing page is a snapshot of my range as a developer. Using just HTML, CSS, and TypeScript, I focused on the essentials—yet the real value came from sharpening my SEO, accessibility, and design skills along the way.'},
