...
export default function About() {
    return (
        <section className="bg-colorPrimary  overflow-clip py-10" id="about">
            <div className=" relative before:block before:z-0 before:absolute  before:inset-x-0  before:bg-colorSecondary/30
                ...
                <article className="container ">
                    <div className="    flex flex-col justify-center items-center pb-12
                                        md:flex-row md:relative px-10 md:px-16 ">

                        <div className=" size-36 relative overflow-clip rounded-2xl z-40  -bottom-12
                                         md:size-56 md:absolute md:top-8 md:left-12
                                        lg:size-64 lg:left-16
                                        xl:left-28">
                            <img src={me} className="object-cover object-center size-full"/>
                        </div>
                        <div className=" rounded-2xl bg-colorSecondary mx-5 text-colorAccent1 z-30 text-justify text-base font-normal font-oswald px-8
                                           md:text-lg  md:w-fit md:pl-40 md:pt-5 md:mt-16 md:ml-20
                                           lg:ml-32
                                           xl:text-2xl xl:ml-44">

                            <h2 className=" text-left text-lg font-bold uppercase mt-16 mb-5
                                            md:text-xl  md:mt-0
                                            lg:text-2xl">
                                About me
                            </h2>

                            <p>I possess over a decade of experience in Software Development, specializing in
                                fullstack development, support, and troubleshooting.</p><br/>

                            <p>With a strong problem-solving acumen and extensive knowledge of CS fundamentals,
                            ...
                            <p className="mb-5">I am currently focusing on Adobe Experience Manager (AEM) and have completed multiple
